/**
 * Slightly modified version of glleria
...
/*
 ---------------------------------------
 2011-06-26
 -add dependy to gkocore for mobile event
 -for mobile add swipe navigation (and remove left right button)
 -remove clicknext options
 -change thumbEventType
 ---------------------------------------
...
(function ($) {
    ...
    // internal constants
        ...
        CLICK = function () {
            return $.support.touch ? 'touchend' : 'click';
            // use this to make touch devices snappier
            //return Galleria.TOUCH ? 'touchend': 'click';
        },
        IE = (function () {
    ...
    var Galleria = function () {
        ...
        var carousel = this._carousel = {
            ...
            bindControls:function () {
                ...
                if ($.support.touch) {
                    self.$('thumbnails-list').bind("swipeleft",
                        function (e) {
                            e.preventDefault();
                    ...
                    carousel.next.bind(self._options.thumbEventType,
                        function (e) {
                            e.preventDefault();
                            //console.log("aaaaa");
                            if (self._options.carouselSteps === 'auto') {
                    ...
                    carousel.prev.bind(self._options.thumbEventType,
                        function (e) {
                            e.preventDefault();
            ...
            bind:function (elem, value) {
                ...
                var hover = function (elem, value) {
                    ...
                    $(elem).hover(function () {
                            ...
                            Galleria.utils.addTimer('tooltip',
                                function () {
                        ...
                        function () {
                            ...
                            Utils.hide(self.get('tooltip'), 200,
                                function () {

                                    self.$('tooltip').hide();

                                    Utils.addTimer('switch_tooltip',
                                        function () {
                                            tooltip.open = false;
                                        },
                                        1000);
        ...
        var fullscreen = this._fullscreen = {
            ...
            enter:function (callback) {
                ...
                self.rescale(function () {
                    ...
                    Utils.addTimer('fullscreen_enter',
                        function () {
            ...
            exit:function (callback) {
                ...
                self.rescale(function () {
                    Utils.addTimer('fullscreen_exit',
                        function () {
        ...
        var lightbox = this._lightbox = {
            ...
            init:function () {
                ...
                hover($(el.close).bind(self._options.thumbEventType, lightbox.hide).html('&#215;'));
                ...
                $.each(['Prev', 'Next'],
                    function (i, dir) {
                        ...
                        $e.bind(self._options.thumbEventType,
                            function () {
                                lightbox['show' + dir]();
                            });
                ...
                $(el.overlay).bind(self._options.thumbEventType, lightbox.hide);
            ...
            show:function (index) {
                ...
                lightbox.image.load(data.image,
                    function (image) {
    ...
    Galleria.prototype = {
        ...
        init:function (target, options) {
            ...
            this._options = {
                ...
                showImagenav:true,
                thumbCrop:true,
                thumbEventType:$.support.touch ? 'touchend' : 'mouseup', //CLICK(),
                thumbFit:true,
                thumbMargin:0,
                thumbQuality:'auto',
                thumbnails:true,
        ...
        _init:function () {
            ...
            $.extend(true, this._options, this._original.options);
            ...
            this.bind(Galleria.DATA,
                function () {
                    ...
                    //	log("Galleria.DATA " + this.getDataLength());
                    // cache the container
                                ...
                                function (i, m) {
                                    ...
                                    if (self._options[m] && typeof self._options[m] === 'number') {
                                        ...
                                        num[m] = Math.max(
                                            ...
                                            // 2. the target css
                                            $container[m](),
                                            // 3. the container jQuery method
                                            self.$('target')[m]()
                                            // 4. the container jQuery method
                                        );
                                    }
                                });
...
//'stage': ['images', 'loader', 'counter', 'image-nav'],
                ...
                'container':['stage', 'thumbnails-container', 'info', 'tooltip', 'counter', 'image-nav']
            });
            ...
            this.$('image-nav-right, image-nav-left').bind(self._options.thumbEventType,
                function (e) {
        ...
        rescale:function (width, height, complete) {
            //Galleria.log("rescale " + width + "x" + height)
            var self = this;
        ...
        _show:function () {
            ...
            var src = this.isFullscreen() && 'big' in data ? data.big : data.image,
            // use big image if fullscreen mode
            ...
            var complete = function () {
                ...
                if (data.link || self._options.lightbox) {
                    ...
                    $(next.image).css({
                        cursor:'pointer'
                    }).bind(self._options.thumbEventType,
                        function () {
            ...
            if (this._options.carousel && this._options.carouselFollow && !this.isPlaying()) {
