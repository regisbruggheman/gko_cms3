...
/* , 'counter', 'image-nav' in gloabl container */
(function ($) {
...
// end Galleria constructor
    ...
    Galleria.prototype = {
        ...
        _track:function (msg) {
            ...
            //console.log(msg + ": " + (timestamp - this.tracker));
            //return timestamp; 
        },
...
// CHANGE PUT BELOW
                ...
                // ADDED
                // need to do that after thumb is pushed in array 
                if (o.showFirstImage && i === o.show) {
                    //this._track("ask to download " + o.show);
                    this.show(o.show);
                }
                // CHANGE PUT BELOW
                // load the thumbnail 
        ...
        _loadTumbnails:function () {
            if (this._options.thumbnails === true) {
                var i,
                    thumb,
                    self = this,
                    o = self._options;
                ...
                for (i = 0; this._data[ i ]; i++) {
                    src = this._data[ i ].thumb || this._data[ i ].image;
                    ;
            ...
            Utils.wait({
                ...
                success:function () {
                    ...
                    if (/^[0-9]{1,4}$/.test(HASH) && Galleria.History) {
                        ...
                        if (!self._options.showFirstImage) {
                            //self._track("Call show LARGE");
                            self.show(self._options.show);
                        }
                    }
        ...
        _show:function () {
            ...
            //self._track("_SHOW data exist ? " + data)		
            if (!data) {
                return;
            }
            ...
            var complete = (function (data, next, active, queue, thumb) {
                //self._track("LARGE complete " + queue.index)
                return function () {
                    ...
                    if (self._queue.length) {
                        //self._track("Have images in the queue " + queue.index);
                        self._show();
                    }
            ...
            // preload images
            /*if ( this._options.preload && queue.index != 0 ) {
             var p, i,
             n = this.getNext(),
             ndata;
            ...
            next.load(src, function (next) {
                ...
                self._scaleImage(next, {
                    ...
                    complete:function (next) {
                        ...
                        if (queue.index === self._options.show) {
