//= require jquery.plupload.1.5.4/js/plupload.full.js
...
var UploadKit = function(input, options) {
  if (!window['plupload']) {
  ...
  var uploader = this.uploader = new plupload.Uploader({
    ...
    flash_swf_url: '/assets/jquery.plupload.1.5.4/js/plupload.flash.swf',
    silverlight_xap_url: '/assets/jquery.plupload.1.5.4/js/plupload.silverlight.xap',
    filters: []
  });
