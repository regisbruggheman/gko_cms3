/**
 * Slightly modify version of galleria to
 * to avoid loading a theme
        ...
        _video = {
            youtube:{
                ...
                getThumb:function (id, success, fail) {
                    fail = fail || F;
                    $.getJSON('http://gdata.youtube.com/feeds/api/videos/' + id + '?v=2&alt=json-in-script&callback=?',
                        function (data) {
                            try {
            ...
            dailymotion:{
                ...
                getThumb:function (id, success, fail) {
                    fail = fail || F;
                    $.getJSON('https://api.dailymotion.com/video/' + id + '?fields=thumbnail_medium_url&callback=?',
                        function (data) {
                            try {
